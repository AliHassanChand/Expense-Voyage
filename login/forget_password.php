...
function sendResetLink($email, $token)
{
    ...
    try {
        ...
        $mail->Password = 'fcox tuhv hfdp ojpv';
        ...
        $mail->Body = "To reset your password, please click the following link: <a href='localhost/Techwiz(5)--Web-Application-Development/Exception-Handlers-(WAD)--TechWiz5/Expense-Voyage/login/reset_password.php?token=$token'>Reset Password</a>";
        $mail->AltBody = "To reset your password, please visit the following link: localhost/Techwiz(5)--Web-Application-Development/Exception-Handlers-(WAD)--TechWiz5/Expense-Voyage/login/reset_password.php?token=$token";
