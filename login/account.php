...
function sendOTP($email, $otp)
{
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'alihassanchand32@gmail.com'; // Your email address
        $mail->Password = 'fcox tuhv hfdp ojpv'; // Your email password (use App Password for Gmail if 2FA is enabled)
